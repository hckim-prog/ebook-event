    ...
    <main className="min-h-screen bg-white text-gray-900 pb-20">
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center bg-gray-50 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 animate-fade-in-up pointer-events-none flex flex-col items-center w-full">
          <div className="bg-white/20 backdrop-blur-lg rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl max-w-7xl mx-auto w-full md:w-auto">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-8 text-gray-900 drop-shadow-sm whitespace-normal break-keep">
              <span className="text-orange-500">한빛+ 전자책 증정</span> 서비스 오픈
            </h1>
            <p className="text-2xl md:text-3xl text-gray-900 max-w-4xl mx-auto mb-12 font-bold leading-relaxed tracking-wide drop-shadow-sm">
            ...
            <div className="pointer-events-auto inline-block">
              <button
                ...
                className="px-10 py-5 bg-white text-black text-xl rounded-full font-bold hover:bg-gray-100 transition-all hover:scale-105 shadow-sm"
              >
                알아보기
              </button>
            </div>
